...
### 0. 设计原则（对标 Airwallex Spend AI / Concur Joule / Expensify Concierge）

ExpenseFlow 沿用现代 AI 原生报销平台（[Airwallex Spend AI 2026](https://www.airwallex.com/blog/meet-your-finance-ai-agents-a-new-way-to-manage-bills-and-expenses)、Concur Joule、Brex AI、Ramp Copilot）共有的三条设计原则：
